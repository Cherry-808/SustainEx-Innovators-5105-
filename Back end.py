...
# Anthropic API Key
ANTHROPIC_API_KEY = "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"
...
# 添加GPT3客户端配置
OPENAI_API_KEY_GPT3 = "sk-svcacct-nQr1W5jpu_4pe_ZHJPSbCTEGvrfde1ffiEOyE5fpvlfK7esm2nYCDm03Qv0n9T3BlbkFJ3CYq5XLBn6yZGXCRgW3LVGxG9gp-rJ9uEhMcujpRO0dteC2Pe3e8aU9nVidAA"
            ...
            for file_name in os.listdir(json_folder):
                if file_name.endswith('.json'):
                    ...
                    with open(file_path, 'r',encoding='utf-8') as file:
                        ...
                        engine = create_engine('sqlite:///SustainEx.db')
                        df.to_sql('users', con=engine, if_exists='replace', index=False)
                        # Establish connection to the database
                        conn = sqlite3.connect('SustainEx.db')
                        cursor = conn.cursor()

                        # Directory where SQL scripts are stored
                        sql_directory = 'C:/Users/92945/Desktop/sql_files'
                        ...
                        for file_name in os.listdir(sql_directory):
                            if file_name.endswith('.sql'):
                                ...
                                df = execute_sql_script(file_path)
